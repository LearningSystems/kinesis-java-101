...
public class AmazonKinesisRecordProducerSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            int partitionKey = count % 2;

            String partitionString = String.valueOf(partitionKey);

            System.out.println("Partition Key is " + partitionString);
            putRecordRequest.setPartitionKey(String.format(partitionString, createTime));
